  ...
  template: `
    <mat-card class="section-card">
      <mat-card-content>
        ...
        <mat-chip-listbox aria-label="Filtro de categorías" (change)="actualizarFiltro($event.value)">
          <mat-chip-option value="Personal" class="chip-Personal">Personal</mat-chip-option>
          <mat-chip-option value="Familia" class="chip-Familia">Familia</mat-chip-option>
          <mat-chip-option value="Trabajo" class="chip-Trabajo">Trabajo</mat-chip-option>
        </mat-chip-listbox>
      </mat-card-content>
    </mat-card>
...
export class BuscadorContactosComponent {
  ...
  actualizarFiltro(valor: string | undefined): void {
    this.contactosService.actualizarFiltroCategoria(valor || null);
  }
