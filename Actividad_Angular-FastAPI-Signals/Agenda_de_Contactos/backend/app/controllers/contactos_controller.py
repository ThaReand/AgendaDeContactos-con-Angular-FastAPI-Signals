...
def obtener_categoria(categoria: str) -> list[Contacto]:
  
    
    categorias_validas=["personal", "familia", "trabajo"]
    if categoria not in categorias_validas:
        raise HTTPException(status_code=400, detail="Categoria inválida")
    
    filtrado = [c for c in contactos_db if c["categoria"] == categoria]
...
def buscar_contactos(texto: str) -> list[Contacto]:
    ...
    resultados = [
        ...
        or texto_normalizado in contacto.categoria.lower()
    ]
